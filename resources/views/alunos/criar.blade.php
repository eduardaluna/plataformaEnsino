...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="container justify-content-center">
            <form method="POST" action="{{url('/salvar/aluno')}}">
                @csrf
                    ...
                    <div class="container pt-3 justify-content-left">
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input id="email" type="email" placeholder="email@exemplo.com" class="form-control @error('email') is-invalid @enderror" name="email" required autofocus/>
                                @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{$message}}</strong>
                                </span>
